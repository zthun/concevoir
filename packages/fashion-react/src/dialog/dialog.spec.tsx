...
describe('ZDialog', () => {
  ...
  const createTestTarget = async (renderDialog: (props: IZDialog) => ReactNode) => {
  ...
  const shouldRenderDialogHeader = async (expected: string, renderDialog: (props: IZDialog) => ReactNode) => {
    // Arrange.
  ...
  const shouldRenderDialogBody = async (expected: string, renderDialog: (props: IZDialog) => ReactNode) => {
    // Arrange.
  ...
  const shouldRenderDialogFooter = async (expected: string, renderDialog: (props: IZDialog) => ReactNode) => {
    // Arrange.
    const [button, modal] = await createTestTarget(renderDialog);
    await button.click();
    await modal.waitForOpen();
  ...
  const shouldOpenDialog = async (renderDialog: (props: IZDialog) => ReactNode) => {
    // Arrange.
    const [button, drawer] = await createTestTarget(renderDialog);
    await button.click();
  ...
  const shouldCloseDialog = async (renderDialog: (props: IZDialog) => ReactNode) => {
    // Arrange.
    const [button, drawer] = await createTestTarget(renderDialog);
    await button.click();
    await drawer.waitForOpen();
  ...
  const shouldNotCloseDialog = async (renderDialog: (props: IZDialog) => ReactNode) => {
    // Arrange.
  ...
  const shouldSetFashion = async (expected: string, renderDialog: (props: IZDialog) => ReactNode) => {
    // Arrange.
    const [button, modal] = await createTestTarget(renderDialog);
    await button.click();
    await modal.waitForOpen();
  ...
  describe('ZDrawer', () => {
    const renderDialog = (overrides: Partial<IZDrawer>, props: IZDialog) => <ZDrawer {...props} {...overrides} />;

    describe('Content', () => {
      it('should render the header', async () => {
        const header = 'Dialog Header';
        const renderHeader = () => header;
        await shouldRenderDialogHeader(header, renderDialog.bind(null, { renderHeader }));
      });

      it('should render the footer', async () => {
        const footer = 'Drawer footer';
        const renderFooter = () => footer;
        await shouldRenderDialogFooter(footer, renderDialog.bind(null, { renderFooter }));
      });

      it('should render the body', async () => {
        const body = 'Drawer Content';
        await shouldRenderDialogBody(body, renderDialog.bind(null, { children: body }));
      });
    });
    ...
    describe('Persistent', () => {
      it('should remain open when escape is pressed', async () => {
        await shouldNotCloseDialog(renderDialog.bind(null, { persistent: true }));
      });
    });
    ...
    describe('Anchor', () => {
      async function shouldAnchor(expected: ZSideAnchor) {
        // Arrange.
        const [, drawer] = await createTestTarget(renderDialog.bind(null, { anchor: expected }));
        // Act.
  ...
  describe('ZModal', () => {
    const renderDialog = (overrides: Partial<IZModal>, props: IZDialog) => <ZModal {...props} {...overrides} />;
  ...
  describe('ZPopup', () => {
    describe('ZModal', () => {
      const renderDialog = (overrides: Partial<IZPopup>, props: IZDialog) => <ZPopup {...props} {...overrides} />;
