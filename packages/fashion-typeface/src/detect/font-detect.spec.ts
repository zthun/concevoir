...
describe('Font Detect', () => {
  const SampleFontSet = Object.freeze([ZFontFamily.ComicSansMs, ZFontFamily.Arial, ZFontFamily.Roboto]);
  ...
  describe('FontFaceSet', () => {
    it('should load available fonts', async () => {
      ...
      fontFaceSet.check = (f: string) => SampleFontSet.some((e) => trimEnd(f, '"').endsWith(e));
