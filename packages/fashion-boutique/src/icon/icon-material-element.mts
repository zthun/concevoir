...
export class ZIconMaterialElement extends HTMLElement implements IZComponentStyles, IZComponentRender {
  public static readonly observedAttributes = ['fashion', 'name'];
  public static readonly Provider = 'https://fonts.googleapis.com/icon?family=Material+Icons';
