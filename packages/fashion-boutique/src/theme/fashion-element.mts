...
export class ZFashionElement extends HTMLElement implements IZComponentStyles {
  @ZProperty({
    initial: new ZFashionBuilder().build(),
    attribute: (f) => f?.name,
  })
  ...
  public styles() {
    ...
    const active = {
      border: firstDefined(
        main,
        this.fashion.active.border,
        this.fashion.active.main,
      ),
    ...
    const focus = {
      border: firstDefined(
        main,
        this.fashion.focus.border,
        this.fashion.focus.main,
      ),
    ...
    const hover = {
      border: firstDefined(
        main,
        this.fashion.hover.border,
        this.fashion.hover.main,
      ),
