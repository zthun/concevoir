...
export interface ZParagraphBodyElement extends IZComponentRender, IZComponentTemplate {}
...
@ZComponentClass('ZTypography-root', 'ZTypography-paragraph', 'ZTypography-paragraph-body')
@ZComponentShadow()
