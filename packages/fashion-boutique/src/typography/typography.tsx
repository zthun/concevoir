...
export interface IZTypographyProps
...
export const ZParagraph = (props: IZTypographyProps) =>
  render("body1", "p", props);
export const ZSubtitle = (props: IZTypographyProps) =>
  render("subtitle1", "p", props);
export const ZCaption = (props: IZTypographyProps) =>
  render("caption", "p", props);
export const ZOverline = (props: IZTypographyProps) =>
  render("overline", "p", props);
