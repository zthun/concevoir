...
export interface ZHeadingFiveElement extends IZComponentRender, IZComponentTemplate {}
...
@ZComponentClass('ZTypography-root', 'ZTypography-heading', 'ZTypography-heading-5')
@ZComponentShadow()
