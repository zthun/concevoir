...
describe("ZFashion", () => {
  ...
  describe("Properties", () => {
    ...
    it("should set the contrast fashion", () => {
      ...
      expect(createTestTarget().contrast(expected).build().contrast).toEqual(
        expected,
      );
    });
    ...
    it("should set the border fashion", () => {
      const expected = rgb(255, 255, 0, 0.5);
      expect(createTestTarget().border(expected).build().border).toEqual(
        expected,
      );
    });
  });
  ...
  describe("Spectrum", () => {
    ...
    it("should set the dark fashion", () => {
      ...
      expect(createTestTarget().spectrum(color, amount).build().dark).toEqual(
        expected,
      );
    });
    ...
    it("should set the light fashion", () => {
      ...
      const amount = 100;
      const expected = hex(brighten(color, amount));
      expect(createTestTarget().spectrum(color, amount).build().light).toEqual(
        expected,
      );
    });
    ...
    it("should set the contrast fashion to black when it has a higher contrast ratio", () => {
      expect(createTestTarget().spectrum(0xffffff).build().contrast).toEqual(
        black(),
      );
    });
