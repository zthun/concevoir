...
When(
  ...
  async function (this: ZFashionWorld<ZTextPageComponentModel>, text: string, name: FieldName) {
...
When(
  ...
  async function (this: ZFashionWorld<ZTextPageComponentModel>, name: OptionName) {
...
Then(
  ...
  async function (this: ZFashionWorld<ZTextPageComponentModel>, name: FieldName, expected: string) {
    const field = await this.parameters.page[name]();
