...
import { ZHeadingComponentModel, ZParagraphComponentModel } from '@zthun/fashion-circus';
  ...
  describe('Fashion', () => {
    describe('Heading', () => {
      const shouldSetFashion = async (
        factory: (t: ZTypographyPageComponentModel) => Promise<ZHeadingComponentModel>
      ) => {
        // Arrange.
    ...
    describe('Paragraph', () => {
      const shouldSetFashion = async (
        factory: (t: ZTypographyPageComponentModel) => Promise<ZParagraphComponentModel>
      ) => {
        // Arrange.
        const target = await createTestTarget();
        const fashion = await target.fashion();
