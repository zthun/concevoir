...
import { ZExperimentalWarning, ZTable } from '@zthun/fashion-labs';
...
export function ZTablePage() {
  ...
  return (
    <>
      <ZExperimentalWarning />
      <ZCard
        className='ZTablePage-root'
        heading={ZFashionRouteTable.name}
        subHeading={ZFashionRouteTable.description}
        avatar={<ZIconFontAwesome name={ZFashionRouteTable.avatar} width={ZSizeFixed.Medium} />}
      >
        <ZH3>Description</ZH3>
        ...
        <ZParagraph>
          ...
          better to use a grid view instead. Tables tend to not be mobile friendly and they usually do not render well
          on small devices.
        </ZParagraph>
