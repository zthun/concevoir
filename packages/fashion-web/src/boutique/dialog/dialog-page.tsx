...
export function ZDialogPage() {
  ...
  return (
    <ZCard
      ...
      avatar={
        <ZIconFontAwesome
          name={ZFashionRouteDialog.avatar}
    ...
    >
      <ZBox margin={{ bottom: ZSizeFixed.Large }}>
        ...
        <ZParagraph>
          Dialogs are UI elements that pop content out to the user. It's not
          always necessary to show the user everything all at once when they do
          not need to see specific elements. Dialog elements help with this.
        </ZParagraph>

        <ZParagraph>
          However, be careful. You do not want to hide too much of your
          interface behind dialogs because it begins to turn into mystery meat
        ...
        <ZGrid
          ...
          columns={{ xl: "1fr 1fr 1fr", sm: "1fr 1fr", xs: "1fr" }}
        >
          <ZDialogButton
            ButtonProps={{
              ...
              label: "Open Drawer",
              avatar: (
                <ZIconFontAwesome name="bars" width={ZSizeFixed.ExtraSmall} />
              ),
          ...
          <ZDialogButton
            ...
            renderDialog={(props: IZModal) => (
              ...
              >
                Modal content is always in the main body. You can put whatever
                you want in a modal, similar to how you can put anything you
                want in any kind of popup body.
              </ZModal>
            )}
          />
          <ZDialogButton
            ...
            renderDialog={(props: IZPopup) => (
              ...
              >
                <ZParagraph compact>
                  You can put whatever you want in a popup.
                </ZParagraph>
              </ZPopup>
            )}
          />
